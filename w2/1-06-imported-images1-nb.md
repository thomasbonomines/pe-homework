...
```{code-cell} ipython3
type(img2[0][0][0])
#C'est une entiers non-signés sur 8 bits
```
...
```{code-cell} ipython3
img4 = plt.imread("data/les-mines.jpg")
```
...
```{code-cell} ipython3
img4 = plt.imread("data/les-mines.jpg")
img9 = img4[261:271,390:410,:]
plt.imshow(img9)
```

```{code-cell} ipython3
img4 = plt.imread("data/les-mines.jpg")
img10 = img4[166:366,300:500,:]
plt.imshow(img10)
```
...
```{code-cell} ipython3
img11 = plt.imread("data/les-mines.jpg")
plt.imshow(img11)
```
...
```{code-cell} ipython3
img_rouge = np.empty((533,800,3))
img_rouge[:,:,:] = [0,0,0]
img_rouge[:,:,0]= rouge
plt.imshow(img_rouge.astype(np.uint8))
```

```{code-cell} ipython3
img_bleue = np.empty((533,800,3))
img_bleue[:,:,:] = [0,0,0]
img_bleue[:,:,2]= bleu
plt.imshow(img_bleue.astype(np.uint8))
```

```{code-cell} ipython3
img_vert = np.empty((533,800,3))
img_vert[:,:,:] = [0,0,0]
img_vert[:,:,1]= vert
plt.imshow(img_vert.astype(np.uint8))
```
...
```{code-cell} ipython3
img12 = img11.copy()
img12[333:533,600:800,:] = [219, 112, 147]
plt.imshow(img12)
#La couleur mystère est du rose
```

```{code-cell} ipython3
img13 = img11.copy()
img13[333:533,600:800,:] = [255, 255, 255]
img13[333::5,600:,:] = [255,0,0]
img13[333:,600::5,:] = [255,0,0]
plt.imshow(img13)
#La couleur mystère est du rose
```
